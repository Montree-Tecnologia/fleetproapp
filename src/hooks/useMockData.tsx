...
const mockVehicles: Vehicle[] = [
  ...
  },
  {
    ...
    driverId: '1',
    hasComposition: true,
    compositionPlates: ['QRS-3579', 'TUV-4680'],
    compositionAxles: [3, 3],
  ...
  },
  {
    ...
    renavam: '00123456814',
    brand: 'Librelato',
    model: 'Baú Frigorífico 3 Eixos Premium',
    manufacturingYear: 2023,
    modelYear: 2023,
    color: 'Branco',
    vehicleType: 'Baú Frigorífico',
